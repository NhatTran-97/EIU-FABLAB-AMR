...
{
    public:
        OdomSubscriber(std::string odom_topic_name):Node("odom_sub_multiThread")
        {
...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<OdomSubscriber> odom_sub_multiThread = 
    ...
    RCLCPP_INFO(odom_sub_multiThread->get_logger(), "odom_subs_node INFO...");
    RCLCPP_INFO(slow_timer_node->get_logger(), "slow_timer_node INFO...");

    rclcpp::executors::MultiThreadedExecutor executor;
    executor.add_node(odom_sub_multiThread);
