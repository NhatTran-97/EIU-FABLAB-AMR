...
#include "nhatbot_controller/pd_motion_planner.hpp"
...
{
PDMotionPlanner::PDMotionPlanner() : Node("pd_motion_planner_node"), kp_(2.0), kd_(0.1), step_size_(0.2), max_linear_velocity_(0.3),
